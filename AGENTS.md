...
- **Load the personal design skill.** For user-facing interface work, use the
  `jashwanth-website-design` skill in `~/.codex/skills`. Adapt it around KINETIQ's
  established light-first academic identity and the stricter rules below.
