...
export function localProfilePage() {
  ...
  return `<section class="page auth-page local-profile-page">
    ...
    <div class="signin-pending">
      ...
      <div>
        <b>Signing in is not available yet.</b>
        <p>Everything on KINETIQ works without an account, and your progress is kept safely in this browser. When sign-in is switched on, this work comes with you.</p>
      </div>
    </div>
