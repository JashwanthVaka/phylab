 ...
 */
const FORMATS = [
  { title: 'Paper 1A mock builder', route: '/exam?paper=1A&count=25&minutes=55', time: 'Up to 55 min', marks: '25-question set', level: 'SL + HL', type: 'Multiple choice', skills: ['Rapid recall', 'Unit awareness', 'Eliminating distractors'], detail: 'Build a full-length KINETIQ multiple-choice set from original questions, then tune level, topics and length.' },
  { title: 'Paper 1B mock builder', route: '/exam?paper=1B&count=15&minutes=35', time: 'Up to 35 min', marks: 'Data-based set', level: 'SL + HL', type: 'Data and experimental skills', skills: ['Gradient interpretation', 'Uncertainty', 'Evidence evaluation'], detail: 'Original data-based questions with graphs, repeated readings, proportional reasoning and experimental judgement.' },
  { title: 'Paper 2 mock builder', route: '/exam?paper=2&count=20&minutes=90', time: '90 min SL · 150 min HL', marks: 'Structured-response set', level: 'SL + HL', type: 'Short and extended response', skills: ['Method setting out', 'Unit conversion', 'Explanation chains'], detail: 'Build a structured paper from KINETIQ questions. Choose SL or HL and adjust length before starting.' },
