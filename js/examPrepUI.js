...
const FORMATS = [
  ...
  { title: 'Weak-topic practice', route: '/quiz?mode=Weak%20Topic%20Quiz', time: '10-15 min', marks: '6 marks', level: 'SL + HL', type: 'Targeted revision', skills: ['Closing gaps', 'Spaced repetition'], detail: 'Focuses on topics your results show need another pass. Falls back to a mixed set until you have results.' },
